...
2. Change the layout of the pages. Use css to do this. You should consider using the `base.css` file located in `static/css`.
...
NOTE:
The default database file has been changed in the `settings.py`. It is call `blog_database.sqlite3`.
